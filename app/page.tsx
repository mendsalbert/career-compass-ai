...
function JakeBadge() {
  return (
    <span className="inline-flex items-center gap-1.5 rounded-full border border-emerald-500/20 bg-gradient-to-r from-emerald-500/10 to-primary/10 px-2.5 py-1 text-[10px] font-semibold text-emerald-600 shadow-sm dark:text-emerald-400">
...
function Navbar() {
  return (
    <nav className="rounded-xl border border-border bg-card px-4 py-3 text-sm shadow-sm sm:px-5 sm:py-3.5">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              Private, personalized, powered by AI
            </p>
          </div>
        </div>
      </div>
...
function Header({
  ...
  return (
    <header className="space-y-3">
      <div className="inline-flex items-center gap-2 rounded-full border border-border bg-card/80 px-3 py-1 text-[11px] text-muted-foreground shadow-sm">
        ...
        <div>
          ...
          <p className="mt-2 max-w-xl text-sm leading-relaxed text-muted-foreground">
            {stage === "onboarding"
              ...
              : "You're on a 12‑month journey—one month at a time. Track progress, adapt as needed, and let Jake guide you."}
          </p>
        </div>
        {stage === "plan" && profile && (
      ...
      <form className="relative grid gap-5 md:grid-cols-2" onSubmit={handleSubmit}>
        ...
        <div className="md:col-span-2 mt-3 flex flex-wrap items-center justify-between gap-4">
          <p className="flex items-center gap-1.5 text-xs leading-snug text-muted-foreground">
            <Lightbulb className="h-3.5 w-3.5 text-primary" />
            <span>We'll use this to sketch a realistic, focused path. Adjust anytime with Jake.</span>
          </p>
          <button
            type="submit"
            disabled={!isValid || isGeneratingPlan}
            className={cn(
              "group relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-full bg-gradient-to-r from-primary to-emerald-500 px-6 py-2.5 text-sm font-semibold text-primary-foreground shadow-lg shadow-primary/25 transition-all hover:shadow-xl hover:shadow-primary/30 disabled:cursor-not-allowed disabled:opacity-60 disabled:shadow-none",
          ...
          <div className="flex items-start gap-3">
           ...
           <div className="flex flex-col items-end gap-2">
            <div className="text-right">
              ...
              <p className="text-2xl font-bold tracking-tight">{overall}<span className="text-sm text-muted-foreground">%</span></p>
            </div>
              ...
              <div className="flex items-start justify-between gap-4">
                ...
                <div className="shrink-0 text-right">
                  ...
                  <p className="mt-1 text-2xl font-bold tracking-tight">
                    {calculateMonthProgress(selectedMonth)}<span className="text-sm text-muted-foreground">%</span>
                  </p>
                </div>
              </div>
      ...
      >
        <div className="relative flex-1">
          <textarea
            ...
            placeholder="Ask Jake anything about your career journey..."
            value={input}
